    ...
    if(CNFlag == 1) {
        ...
        if(PORTAbits.RA2 == 0) {
            ...
            if(PB1_Pressed == 1) {
                ...
                PB1_Pressed = 0; //reset global, call ADC.
                CNEN1bits.CN1IE = 0; //disable input change Notif on RB4/PB3
                CNEN1bits.CN0IE = 0; //disable input change Notif on RA4/PB2
                CNEN2bits.CN30IE = 0; //disable input change Notif on RA2/PB1
                RunADC();//call ADC helper function
                Idle();
                return;
            } else {
                CNFlag = 1;
    ...
    if(CNFlag == 1) {
        ...
        if(PORTAbits.RA4 == 0) {
            ...
            if(PB2_Pressed == 1) {
                ...
                CNEN1bits.CN0IE = 0; //disable input change Notif on RA4/PB2
                CNEN2bits.CN30IE = 0; //disable input change Notif on RA2/PB1
                PB2_Pressed = 0; //reset global, call ADC.
                RunADC();
                Idle();
                return;
            } else {
    ...
    if(CNFlag == 1) {
        ...
        if(PORTBbits.RB4 == 0) {
            ...
            if(PB3_Pressed == 1) {
                ...
                CNEN1bits.CN0IE = 0; //disable input change Notif on RA4/PB2
                CNEN2bits.CN30IE = 0; //disable input change Notif on RA2/PB1
                PB3_Pressed = 0; //reset global, call ADC.
                RunADC();
                Idle();
                return;
            } else {
